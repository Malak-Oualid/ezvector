...
public class Customer extends Person
{
  ...
  public boolean addCustomerCart(Plasmid aCustomerCart)
  {
    ...
    if (customerCart.contains(aCustomerCart)) { return false; }
  ...
  {  
    ...
    {
      if(index < 0 ) { index = 0; }
      if(index > numberOfCustomerCart()) { index = numberOfCustomerCart() - 1; }
      customerCart.remove(aCustomerCart);
  ...
  {
    boolean wasAdded = false;
    if (customerBackbones.contains(aCustomerBackbone)) { return false; }
  ...
  {  
    ...
    {
      if(index < 0 ) { index = 0; }
      if(index > numberOfCustomerBackbones()) { index = numberOfCustomerBackbones() - 1; }
      customerBackbones.remove(aCustomerBackbone);
