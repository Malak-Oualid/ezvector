    ...
    <>
      ...
      <div style={{ paddingTop: 60, minHeight: "100vh" }}>
        ...
        <div style={{ textAlign: "center", padding: "4rem 2rem", background: "linear-gradient(to bottom right, rgba(244,246,250,0.7), rgba(212,218,232,0.5))", borderBottom: "1px solid #d4dae8", marginBottom: "2rem" }}>
          ...
          <p style={{ color: "#4a5a78", maxWidth: "36rem", margin: "0 auto" }}>Clone synthetic DNA fragments into any plasmid backbone, without onboarding fees.</p>
            ...
            <>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "2rem", marginBottom: "3rem" }}>
                <div className="value-card" style={{ background: "#fff", border: "1px solid #d4dae8", borderRadius: 14, padding: "2rem", textAlign: "center", transition: "all 0.2s" }}>
                  <h3 style={{ fontSize: "1.25rem", fontWeight: 600, color: "#1d3461", marginBottom: "0.75rem" }}>Clone Into Your Plasmid</h3>
                  <p style={{ color: "#4a5a78", lineHeight: 1.75 }}>Clone into your vector, not a vendor's. We'll work with any backbone, from low-copy to custom constructs.</p>
                </div>
                <div className="value-card" style={{ background: "#fff", border: "1px solid #d4dae8", borderRadius: 14, padding: "2rem", textAlign: "center", transition: "all 0.2s" }}>
                  <h3 style={{ fontSize: "1.25rem", fontWeight: 600, color: "#1d3461", marginBottom: "0.75rem" }}>No Onboarding Fees</h3>
                  <p style={{ color: "#4a5a78", lineHeight: 1.75 }}>Forget the hidden charges. We'll build your plasmid directly, no setup costs or minimums attached.</p>
                </div>
                <div className="value-card" style={{ background: "#fff", border: "1px solid #d4dae8", borderRadius: 14, padding: "2rem", textAlign: "center", transition: "all 0.2s" }}>
                  <h3 style={{ fontSize: "1.25rem", fontWeight: 600, color: "#1d3461", marginBottom: "0.75rem" }}>Hassle Free</h3>
                  <p style={{ color: "#4a5a78", lineHeight: 1.75 }}>No quote requests and endless email chains. Let us coordinate with synthesis providers so you don't have to.</p>
                </div>
              </div>
              ...
              <div style={{ background: "#fff", border: "1px solid #d4dae8", borderRadius: 8, padding: "2rem" }}>
                ...
                <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "0.875rem" }}>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td style={{ padding: "0.75rem 1rem", borderBottom: "1px solid #d4dae8", color: "#1d3461", fontWeight: 500 }}>Onboarding Costs</td>
                      <td style={{ padding: "0.75rem 1rem", borderBottom: "1px solid #d4dae8", color: "#1d3461", background: "rgba(29,52,97,0.03)" }}>No onboarding fees. Pay only for what you build.</td>
                      <td style={{ padding: "0.75rem 1rem", borderBottom: "1px solid #d4dae8", color: "#4a5a78" }}>Added setup and onboarding fees per vector.</td>
                      <td style={{ padding: "0.75rem 1rem", borderBottom: "1px solid #d4dae8", color: "#4a5a78" }}>High reagent and consumable costs.</td>
                    </tr>
                    <tr>
                      <td style={{ padding: "0.75rem 1rem", color: "#1d3461", fontWeight: 500 }}>Coordination Burden</td>
                      <td style={{ padding: "0.75rem 1rem", color: "#1d3461", background: "rgba(29,52,97,0.03)" }}>We handle all vendor communication.</td>
                      <td style={{ padding: "0.75rem 1rem", color: "#4a5a78" }}>Multiple quote requests and email chains.</td>
                      <td style={{ padding: "0.75rem 1rem", color: "#4a5a78" }}>None</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div style={{ background: "#fff", border: "1px solid #d4dae8", borderRadius: 8, padding: "2rem" }}>
              ...
              <div style={{ marginTop: "1.5rem", padding: "1rem", background: "rgba(239,246,255,0.5)", border: "1px solid #bfdbfe", borderRadius: 8 }}>
                <p style={{ fontSize: "0.875rem", color: "#4a5a78" }}>
                  <strong style={{ color: "#1d3461" }}>Note:</strong> The price and turnaround time of plasmids requiring DNA synthesis depend on the length and complexity of synthetic insert.
                </p>
              </div>
              <div style={{ marginTop: "1rem", padding: "1rem", background: "#1d3461", color: "#fff", borderRadius: 8 }}>
            ...
            <div style={{ background: "#fff", border: "1px solid #d4dae8", borderRadius: 8, padding: "2rem" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                <div style={{ borderBottom: "1px solid #d4dae8", paddingBottom: "1rem" }}>
                  <h3 style={{ fontWeight: 600, color: "#1d3461", marginBottom: "0.5rem" }}>What DNA synthesis providers do you work with?</h3>
                  <p style={{ color: "#4a5a78", fontSize: "0.875rem" }}>We work with all major DNA synthesis providers. We'll coordinate with your preferred vendor or recommend one based on your needs.</p>
                </div>
                <div style={{ borderBottom: "1px solid #d4dae8", paddingBottom: "1rem" }}>
                  <h3 style={{ fontWeight: 600, color: "#1d3461", marginBottom: "0.5rem" }}>Can I use my own synthetic DNA?</h3>
                  <p style={{ color: "#4a5a78", fontSize: "0.875rem" }}>Yes! If you already have synthetic DNA, we can clone it directly into your vector without additional synthesis costs.</p>
                </div>
                <div style={{ borderBottom: "1px solid #d4dae8", paddingBottom: "1rem" }}>
                  <h3 style={{ fontWeight: 600, color: "#1d3461", marginBottom: "0.5rem" }}>What if my plasmid fails?</h3>
                  <p style={{ color: "#4a5a78", fontSize: "0.875rem" }}>In the rare event of a cloning failure, we'll rebuild your plasmid at no additional cost. Your satisfaction is guaranteed.</p>
                </div>
                <div>
                  <h3 style={{ fontWeight: 600, color: "#1d3461", marginBottom: "0.5rem" }}>Do you offer discounts for bulk orders?</h3>
                  <p style={{ color: "#4a5a78", fontSize: "0.875rem" }}>Yes, we offer volume discounts for orders of 10 or more plasmids. Contact us for a custom quote.</p>
                </div>
              </div>
            </div>
          )}
