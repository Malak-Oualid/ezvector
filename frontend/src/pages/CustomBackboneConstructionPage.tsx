      ...
      <div style={{ paddingTop: 60, minHeight: "100vh" }}>
        ...
        <div style={{ maxWidth: "72rem", margin: "0 auto", padding: "0 2rem", paddingBottom: "4rem" }}>
          {activeTab === "about" && (
            <>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "2rem", marginBottom: "3rem" }}>
                ...
                <div className="value-card" style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 14, padding: "2rem", textAlign: "center", transition: "all 0.2s" }}>
                  <h3 style={{ fontSize: "1.25rem", fontWeight: 600, color: "#111827", marginBottom: "0.75rem" }}>Unlimited Design Freedom</h3>
              ...
              <div style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 8, padding: "2rem" }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: "1.5rem" }}>
                  <div>
                    ...
                    <p style={{ color: "#4b5563", fontSize: "0.875rem" }}>Ampicillin, Kanamycin, Chloramphenicol, Tetracycline, and more</p>
                  </div>
                  <div>
                    <h4 style={{ fontWeight: 600, color: "#111827", marginBottom: "0.5rem" }}>Origins of Replication</h4>
                    <p style={{ color: "#4b5563", fontSize: "0.875rem" }}>High-copy, low-copy, medium-copy, and inducible origins</p>
                  </div>
                  <div>
                    <h4 style={{ fontWeight: 600, color: "#111827", marginBottom: "0.5rem" }}>Promoters</h4>
                    <p style={{ color: "#4b5563", fontSize: "0.875rem" }}>Constitutive, inducible, tissue-specific, and synthetic promoters</p>
                  </div>
                  <div>
                    <h4 style={{ fontWeight: 600, color: "#111827", marginBottom: "0.5rem" }}>Reporters & Tags</h4>
                    <p style={{ color: "#4b5563", fontSize: "0.875rem" }}>GFP, RFP, His-tag, FLAG-tag, and other fusion tags</p>
                  </div>
                </div>
              </div>
            </>
            ...
            <div style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 8, padding: "2rem" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                <div style={{ border: "1px solid #d1d5db", borderRadius: 8, padding: "1.5rem", background: "rgba(249,250,251,0.5)" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "0.5rem" }}>
                    <div>
                      <h3 style={{ fontSize: "1.125rem", fontWeight: 600, color: "#111827", fontFamily: "DM Mono, monospace" }}>CUSTOM_BACKBONE_ASSEMBLY</h3>
                      <p style={{ fontSize: "0.75rem", color: "#6b7280", fontFamily: "DM Mono, monospace" }}>ID: BB-CUSTOM-001</p>
                    </div>
                    <span style={{ fontSize: "1.5rem", fontWeight: 700, color: "#111827", fontFamily: "DM Mono, monospace" }}>$200.00</span>
                  </div>
                  <p style={{ color: "#4b5563", fontSize: "0.875rem", marginBottom: "0.5rem" }}>Includes: assembly and verification of custom backbone with up to 4 components</p>
                ...
                <div style={{ border: "1px solid #d1d5db", borderRadius: 8, padding: "1.5rem", background: "rgba(249,250,251,0.5)" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "0.5rem" }}>
                    <div>
                      <h3 style={{ fontSize: "1.125rem", fontWeight: 600, color: "#111827", fontFamily: "DM Mono, monospace" }}>ADDITIONAL_COMPONENT</h3>
                      <p style={{ fontSize: "0.75rem", color: "#6b7280", fontFamily: "DM Mono, monospace" }}>ID: BB-COMP-ADD-001</p>
                    </div>
                    <span style={{ fontSize: "1.5rem", fontWeight: 700, color: "#111827", fontFamily: "DM Mono, monospace" }}>$25.00</span>
                  </div>
                  <p style={{ color: "#4b5563", fontSize: "0.875rem", marginBottom: "0.5rem" }}>Each additional component beyond 4</p>
                  <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", fontSize: "0.75rem", color: "#6b7280", fontFamily: "DM Mono, monospace" }}>
              ...
              <div style={{ marginTop: "1.5rem", padding: "1rem", background: "rgba(239,246,255,0.5)", border: "1px solid #bfdbfe", borderRadius: 8 }}>
                <p style={{ fontSize: "0.875rem", color: "#4b5563" }}>
                  <strong style={{ color: "#111827" }}>Note:</strong> Complex backbones with many components may require additional time. Contact us for a custom quote on large projects.
                </p>
              </div>
            </div>
          )}
          ...
          {activeTab === "sample-prep" && (
            <div style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 8, padding: "2rem" }}>
              <h2 style={{ fontSize: "1.5rem", fontWeight: 600, color: "#111827", marginBottom: "1.5rem" }}>Design Submission Guidelines</h2>
              <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                <div style={{ borderLeft: "4px solid #111827", paddingLeft: "1rem" }}>
                  <h4 style={{ fontWeight: 600, color: "#111827", marginBottom: "0.25rem" }}>Provide Component Sequences</h4>
                  <p style={{ color: "#4b5563", fontSize: "0.875rem" }}>Submit sequences for each component (markers, origins, promoters, etc.) in FASTA or GenBank format.</p>
                </div>
                <div style={{ borderLeft: "4px solid #2563eb", paddingLeft: "1rem" }}>
                  <h4 style={{ fontWeight: 600, color: "#111827", marginBottom: "0.25rem" }}>Specify Assembly Order</h4>
                  <p style={{ color: "#4b5563", fontSize: "0.875rem" }}>Clearly indicate the desired order and orientation of each component in the final plasmid.</p>
                </div>
                <div style={{ borderLeft: "4px solid #16a34a", paddingLeft: "1rem" }}>
                  <h4 style={{ fontWeight: 600, color: "#111827", marginBottom: "0.25rem" }}>Include Restriction Sites (Optional)</h4>
                  <p style={{ color: "#4b5563", fontSize: "0.875rem" }}>If you need specific restriction sites for future cloning, include them in your design specifications.</p>
                </div>
              </div>
            ...
            <div style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 8, padding: "2rem" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                <div style={{ borderBottom: "1px solid #e5e7eb", paddingBottom: "1rem" }}>
                  <h3 style={{ fontWeight: 600, color: "#111827", marginBottom: "0.5rem" }}>What components can I include?</h3>
                  <p style={{ color: "#4b5563", fontSize: "0.875rem" }}>You can include any standard plasmid components: selectable markers, origins of replication, promoters, reporters, tags, multiple cloning sites, and more.</p>
                </div>
                <div style={{ borderBottom: "1px solid #e5e7eb", paddingBottom: "1rem" }}>
                  <h3 style={{ fontWeight: 600, color: "#111827", marginBottom: "0.5rem" }}>Is there a limit on the number of components?</h3>
                  <p style={{ color: "#4b5563", fontSize: "0.875rem" }}>Our standard service includes up to 4 components. For more complex backbones, contact us for a custom quote.</p>
                </div>
                <div style={{ borderBottom: "1px solid #e5e7eb", paddingBottom: "1rem" }}>
                  <h3 style={{ fontWeight: 600, color: "#111827", marginBottom: "0.5rem" }}>Can you use my existing DNA parts?</h3>
                  <p style={{ color: "#4b5563", fontSize: "0.875rem" }}>Yes, if you have existing DNA parts, we can incorporate them into your custom backbone design.</p>
                </div>
                <div>
                  <h3 style={{ fontWeight: 600, color: "#111827", marginBottom: "0.5rem" }}>What if the assembly fails?</h3>
                  <p style={{ color: "#4b5563", fontSize: "0.875rem" }}>In the rare event of a failure, we'll rebuild your backbone at no additional cost. Your satisfaction is guaranteed.</p>
                </div>
              </div>
            </div>
          )}
