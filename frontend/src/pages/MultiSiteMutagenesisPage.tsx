    ...
    <>
      ...
      <div style={{ paddingTop: 60, minHeight: "100vh" }}>
        ...
        <div style={{ textAlign: "center", padding: "4rem 2rem", background: "linear-gradient(to bottom right, rgba(239,246,255,0.5), rgba(219,234,254,0.5))", borderBottom: "1px solid #e5e7eb", marginBottom: "2rem" }}>
          ...
          <p style={{ color: "#4b5563", maxWidth: "36rem", margin: "0 auto" }}>Make targeted site-directed or codon-level mutations at up to five sites in a single build.</p>
            ...
            <>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "2rem", marginBottom: "3rem" }}>
                <div className="value-card" style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 14, padding: "2rem", textAlign: "center", transition: "all 0.2s" }}>
                  <h3 style={{ fontSize: "1.25rem", fontWeight: 600, color: "#111827", marginBottom: "0.75rem" }}>Multi-Site Mutagenesis</h3>
                ...
                <div className="value-card" style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 14, padding: "2rem", textAlign: "center", transition: "all 0.2s" }}>
                  <h3 style={{ fontSize: "1.25rem", fontWeight: 600, color: "#111827", marginBottom: "0.75rem" }}>Codon Mutagenesis</h3>
              ...
              <div style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 8, padding: "2rem" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                  <div style={{ borderLeft: "4px solid #111827", paddingLeft: "1rem" }}>
                    <h4 style={{ fontWeight: 600, color: "#111827", marginBottom: "0.25rem" }}>Site-Directed Mutagenesis</h4>
                    <p style={{ color: "#4b5563", fontSize: "0.875rem" }}>Introduce precise point mutations, deletions, or insertions at specific locations in your plasmid.</p>
                  </div>
                  <div style={{ borderLeft: "4px solid #2563eb", paddingLeft: "1rem" }}>
                    <h4 style={{ fontWeight: 600, color: "#111827", marginBottom: "0.25rem" }}>Codon Optimization</h4>
                    <p style={{ color: "#4b5563", fontSize: "0.875rem" }}>Optimize codon usage for expression in different organisms or create synonymous variants for functional studies.</p>
                  </div>
                  <div style={{ borderLeft: "4px solid #16a34a", paddingLeft: "1rem" }}>
                    <h4 style={{ fontWeight: 600, color: "#111827", marginBottom: "0.25rem" }}>Variant Libraries</h4>
                    <p style={{ color: "#4b5563", fontSize: "0.875rem" }}>Generate parallel designs or randomized libraries for screening and selection experiments.</p>
                  </div>
                </div>
              </div>
            </>
            ...
            <div style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 8, padding: "2rem" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                <div style={{ border: "1px solid #d1d5db", borderRadius: 8, padding: "1.5rem", background: "rgba(249,250,251,0.5)" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "0.5rem" }}>
                    <div>
                      <h3 style={{ fontSize: "1.125rem", fontWeight: 600, color: "#111827", fontFamily: "DM Mono, monospace" }}>BASE_MUTAGENESIS_SERVICE</h3>
                      <p style={{ fontSize: "0.75rem", color: "#6b7280", fontFamily: "DM Mono, monospace" }}>ID: MUT-BASE-001</p>
                    </div>
                    <span style={{ fontSize: "1.5rem", fontWeight: 700, color: "#111827", fontFamily: "DM Mono, monospace" }}>$120.00</span>
                  </div>
                  <p style={{ color: "#4b5563", fontSize: "0.875rem", marginBottom: "0.5rem" }}>Includes: up to 5 site-directed mutations in a single build</p>
                ...
                <div style={{ border: "1px solid #d1d5db", borderRadius: 8, padding: "1.5rem", background: "rgba(249,250,251,0.5)" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "0.5rem" }}>
                    <div>
                      <h3 style={{ fontSize: "1.125rem", fontWeight: 600, color: "#111827", fontFamily: "DM Mono, monospace" }}>CODON_LEVEL_MUTAGENESIS</h3>
                      <p style={{ fontSize: "0.75rem", color: "#6b7280", fontFamily: "DM Mono, monospace" }}>ID: MUT-CODON-001</p>
                    </div>
                    <span style={{ fontSize: "1.5rem", fontWeight: 700, color: "#111827", fontFamily: "DM Mono, monospace" }}>$150.00</span>
                  </div>
                  <p style={{ color: "#4b5563", fontSize: "0.875rem", marginBottom: "0.5rem" }}>Includes: codon optimization or codon-level variant generation</p>
                  <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", fontSize: "0.75rem", color: "#6b7280", fontFamily: "DM Mono, monospace" }}>
              ...
              <div style={{ marginTop: "1.5rem", padding: "1rem", background: "rgba(239,246,255,0.5)", border: "1px solid #bfdbfe", borderRadius: 8 }}>
                <p style={{ fontSize: "0.875rem", color: "#4b5563" }}>
                  <strong style={{ color: "#111827" }}>Note:</strong> Each additional mutation beyond 5 sites may incur additional fees. Contact us for custom projects.
                </p>
              </div>
            </div>
          )}
            ...
            <div style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 8, padding: "2rem" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                <div style={{ borderBottom: "1px solid #e5e7eb", paddingBottom: "1rem" }}>
                  <h3 style={{ fontWeight: 600, color: "#111827", marginBottom: "0.5rem" }}>What types of mutations can you make?</h3>
                  <p style={{ color: "#4b5563", fontSize: "0.875rem" }}>We can make point mutations, deletions, insertions, and codon-level changes. Contact us for more complex modifications.</p>
                </div>
                <div style={{ borderBottom: "1px solid #e5e7eb", paddingBottom: "1rem" }}>
                  <h3 style={{ fontWeight: 600, color: "#111827", marginBottom: "0.5rem" }}>Do I need to provide primers?</h3>
                  <p style={{ color: "#4b5563", fontSize: "0.875rem" }}>No, we design and synthesize all primers needed for your mutagenesis project.</p>
                </div>
                <div style={{ borderBottom: "1px solid #e5e7eb", paddingBottom: "1rem" }}>
                  <h3 style={{ fontWeight: 600, color: "#111827", marginBottom: "0.5rem" }}>Can you make mutations in any plasmid?</h3>
                  <p style={{ color: "#4b5563", fontSize: "0.875rem" }}>Yes, we can introduce mutations into any plasmid backbone you provide, regardless of size or complexity.</p>
                </div>
                <div>
