    ...
    <>
      ...
      <div style={{ paddingTop: 60, minHeight: "100vh" }}>
        ...
        <div style={{ textAlign: "center", padding: "4rem 2rem", background: "linear-gradient(to bottom right, rgba(244,246,250,0.7), rgba(212,218,232,0.5))", borderBottom: "1px solid #d4dae8", marginBottom: "2rem" }}>
          ...
          <p style={{ color: "#4a5a78", maxWidth: "36rem", margin: "0 auto" }}>Create variant libraries by mutating separate DNA domains on your plasmid all at once.</p>
          ...
          {activeTab === "about" && (
            <>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "2rem", marginBottom: "3rem" }}>
                ...
                <div className="value-card" style={{ background: "#fff", border: "1px solid #d4dae8", borderRadius: 14, padding: "2rem", textAlign: "center", transition: "all 0.2s" }}>
                  <h3 style={{ fontSize: "1.25rem", fontWeight: 600, color: "#1d3461", marginBottom: "0.75rem" }}>Seamless Integration of Parts</h3>
              ...
              <div style={{ background: "#fff", border: "1px solid #d4dae8", borderRadius: 8, padding: "2rem" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                  <div style={{ borderLeft: "4px solid #1d3461", paddingLeft: "1rem" }}>
                    <h4 style={{ fontWeight: 600, color: "#1d3461", marginBottom: "0.25rem" }}>Protein Domain Swapping</h4>
                    <p style={{ color: "#4a5a78", fontSize: "0.875rem" }}>Swap functional domains between proteins to study structure-function relationships and create chimeric proteins.</p>
                  </div>
                  <div style={{ borderLeft: "4px solid #5b7fb5", paddingLeft: "1rem" }}>
                    <h4 style={{ fontWeight: 600, color: "#1d3461", marginBottom: "0.25rem" }}>Promoter/Enhancer Libraries</h4>
                    <p style={{ color: "#4a5a78", fontSize: "0.875rem" }}>Generate libraries of promoter variants to optimize expression levels across different conditions.</p>
                  </div>
                  <div style={{ borderLeft: "4px solid #16a34a", paddingLeft: "1rem" }}>
                    <h4 style={{ fontWeight: 600, color: "#1d3461", marginBottom: "0.25rem" }}>Binding Site Optimization</h4>
                    <p style={{ color: "#4a5a78", fontSize: "0.875rem" }}>Systematically mutate binding domains to optimize affinity, specificity, or other functional properties.</p>
                  </div>
                </div>
              </div>
            </>
            ...
            <div style={{ background: "#fff", border: "1px solid #d4dae8", borderRadius: 8, padding: "2rem" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                <div style={{ border: "1px solid #b8c3d8", borderRadius: 8, padding: "1.5rem", background: "rgba(244,246,250,0.5)" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "0.5rem" }}>
                    <div>
                      <h3 style={{ fontSize: "1.125rem", fontWeight: 600, color: "#1d3461", fontFamily: "DM Mono, monospace" }}>SINGLE_DOMAIN_MUTAGENESIS</h3>
                      <p style={{ fontSize: "0.75rem", color: "#7a8ca8", fontFamily: "DM Mono, monospace" }}>ID: DM-SINGLE-001</p>
                    </div>
                    <span style={{ fontSize: "1.5rem", fontWeight: 700, color: "#1d3461", fontFamily: "DM Mono, monospace" }}>$100.00</span>
                  </div>
                  <p style={{ color: "#4a5a78", fontSize: "0.875rem", marginBottom: "0.5rem" }}>Includes: mutagenesis of one domain with up to 5 mutations</p>
                ...
                <div style={{ border: "1px solid #b8c3d8", borderRadius: 8, padding: "1.5rem", background: "rgba(244,246,250,0.5)" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "0.5rem" }}>
                    <div>
                      <h3 style={{ fontSize: "1.125rem", fontWeight: 600, color: "#1d3461", fontFamily: "DM Mono, monospace" }}>TWO_DOMAIN_MUTAGENESIS</h3>
                      <p style={{ fontSize: "0.75rem", color: "#7a8ca8", fontFamily: "DM Mono, monospace" }}>ID: DM-DOUBLE-001</p>
                    </div>
                    <span style={{ fontSize: "1.5rem", fontWeight: 700, color: "#1d3461", fontFamily: "DM Mono, monospace" }}>$180.00</span>
                  </div>
                  <p style={{ color: "#4a5a78", fontSize: "0.875rem", marginBottom: "0.5rem" }}>Includes: mutagenesis of two domains with up to 5 mutations each</p>
                  <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", fontSize: "0.75rem", color: "#7a8ca8", fontFamily: "DM Mono, monospace" }}>
                ...
                <div style={{ border: "1px solid #b8c3d8", borderRadius: 8, padding: "1.5rem", background: "rgba(244,246,250,0.5)" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "0.5rem" }}>
                    <div>
                      <h3 style={{ fontSize: "1.125rem", fontWeight: 600, color: "#1d3461", fontFamily: "DM Mono, monospace" }}>THREE_DOMAIN_MUTAGENESIS</h3>
                      <p style={{ fontSize: "0.75rem", color: "#7a8ca8", fontFamily: "DM Mono, monospace" }}>ID: DM-TRIPLE-001</p>
                    </div>
                    <span style={{ fontSize: "1.5rem", fontWeight: 700, color: "#1d3461", fontFamily: "DM Mono, monospace" }}>$250.00</span>
                  </div>
                  <p style={{ color: "#4a5a78", fontSize: "0.875rem", marginBottom: "0.5rem" }}>Includes: mutagenesis of three domains with up to 5 mutations each</p>
                  <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", fontSize: "0.75rem", color: "#7a8ca8", fontFamily: "DM Mono, monospace" }}>
              ...
              <div style={{ marginTop: "1.5rem", padding: "1rem", background: "rgba(239,246,255,0.5)", border: "1px solid #bfdbfe", borderRadius: 8 }}>
                <p style={{ fontSize: "0.875rem", color: "#4a5a78" }}>
                  <strong style={{ color: "#1d3461" }}>Note:</strong> Additional mutations beyond 5 per domain may incur extra fees. Contact us for complex projects.
                </p>
              </div>
            </div>
          )}
            ...
            <div style={{ background: "#fff", border: "1px solid #d4dae8", borderRadius: 8, padding: "2rem" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                <div style={{ borderBottom: "1px solid #d4dae8", paddingBottom: "1rem" }}>
                  <h3 style={{ fontWeight: 600, color: "#1d3461", marginBottom: "0.5rem" }}>What defines a "domain"?</h3>
                  <p style={{ color: "#4a5a78", fontSize: "0.875rem" }}>A domain is a distinct functional or structural region of your protein. Common examples include binding domains, catalytic domains, transmembrane regions, and signal peptides.</p>
                </div>
                <div style={{ borderBottom: "1px solid #d4dae8", paddingBottom: "1rem" }}>
                  <h3 style={{ fontWeight: 600, color: "#1d3461", marginBottom: "0.5rem" }}>Can I randomize mutations within a domain?</h3>
                  <p style={{ color: "#4a5a78", fontSize: "0.875rem" }}>Yes, we can create randomized libraries within specified domains. Contact us to discuss your library design requirements.</p>
                </div>
                <div style={{ borderBottom: "1px solid #d4dae8", paddingBottom: "1rem" }}>
                  <h3 style={{ fontWeight: 600, color: "#1d3461", marginBottom: "0.5rem" }}>How do you ensure domain boundaries are respected?</h3>
                  <p style={{ color: "#4a5a78", fontSize: "0.875rem" }}>We carefully design primers to target specific domain boundaries based on your specifications or sequence analysis.</p>
                </div>
                <div>
