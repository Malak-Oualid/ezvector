...
export default function Footer() {
    const links = [
        ...
        { label: "How-to", to: "/how-to/submit-orders" },
        { label: "FAQ", to: "/faq" },
    ...
    return (
        <footer style={{ background: "#1d3461", color: "rgba(255,255,255,0.7)", padding: "2.5rem 3rem", display: "flex", alignItems: "center", justifyContent: "space-between", fontSize: "0.82rem" }}>
            ...
            <nav style={{ display: "flex", gap: 0 }}>
                {links.map(l => (
                    <Link key={l.label} to={l.to} style={{ color: "rgba(255,255,255,0.6)", textDecoration: "none", marginLeft: "1.5rem", transition: "color 0.15s" }}
